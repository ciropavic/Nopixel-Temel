...
function ToggleBar(toggle, boundItems, boundItemsAmmo) {
    if (toggle) {
        ...
        if (boundItems[1]) {
            ...
            htmlstring =
                "<div class='item3' ><div class='quickbind' id='bind1'> 1 </div><div class='itemname3'> boş </div> <img src='icons/empty.png' class='itemimage'>  </div>";
        }
        ...
        for (let i = 2; i < 5; i++) {
            if (boundItems[i]) {
                ...
                htmlstring =
                    htmlstring +
                    "<div class='item3' >" + "<div class='quickbind' id='bind" + i + "'>" + i + "</div> " + "<div class='itemname3'> boş </div> <img src='icons/empty.png' class='itemimage'>  </div>";
            }
        }
...
function UpdateSetWeights(secondaryName) {
    ...
    if (!$('#mainInvHeading').html() || $('#secondaryInvName').attr('title') !== TargetInventoryName) {
        let mainHeader = `
            <h1 id='mainInvName' class='inventory-name' title='${PlayerInventoryName}'>Oyuncu</h1>
