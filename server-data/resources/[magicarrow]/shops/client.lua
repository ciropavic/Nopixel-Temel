...
AddEventHandler("shop:game:open", function()
	TriggerEvent("server-inventory-open", "2", "Shop");	
	Wait(1000)
end)

AddEventHandler("gunshop:game:open", function()
	TriggerEvent("server-inventory-open", "5", "Shop");
	Wait(1000)
end)

AddEventHandler("megamall:game:open", function()
	TriggerEvent("server-inventory-open", "4", "Shop");
	Wait(1000)
end)

AddEventHandler("bein:game:open", function()
	TriggerEvent("openSubMenu", "12", "Shop");
	Wait(1000)
end)

AddEventHandler("pdarmory:game:open", function()
